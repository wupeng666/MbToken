...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract MbToken is IBEP20, OwnAdmin
{
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MeerBunny";
    string private _symbol = "MB";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 210420000 * 10**_decimals;
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;

    address public deadAddress2 = 0x0000000000000000000000000000000000000000;
    address payable public HuPangCon = payable(0x79f3c6be54f18FB3E62B513F248c0126Ac8C91a5); 
    // TEST:0x1a5771B07dd54FbA6dF11E7F4873Da3bfa5ecb79   USDT:0x55d398326f99059fF775485246999027B3197955
    address meerAddress = address(0x470cBFB236860eb5257bBF78715FB5bd77119C2F);
    //test 0xD99D1c33F9fC3444f8101754aBC46c52416550D1   0xFEDBCdc8998dd86aB6FB5935BBC4BEe689F1D5B9
    address  public wapV2RouterAddress = address(0xFEDBCdc8998dd86aB6FB5935BBC4BEe689F1D5B9);
...
contract son is OwnAdmin{
    ...
    address meer = 0x470cBFB236860eb5257bBF78715FB5bd77119C2F;
